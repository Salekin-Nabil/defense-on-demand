    ...
    return (
        <div className=''>
            <div className="flex justify-center my-[5vw] relative ">
                <div className="rounded-3xl shadow-2xl shadow-white bg-[#beafa7] max-w-sm p-5 h-[600px] hover:bg-indigo-50 mx-2">

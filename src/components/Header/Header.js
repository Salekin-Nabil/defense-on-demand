...
const Header = () => {
    ...
    return (
        <nav className='bg-black py-4  shadow-2xl shadow-white'>
            <div className='flex items-center'>
                ...
                <div className={`md:flex bg-black justify-center md:static w-full absolute duration-500 ease-in ${open ? 'top-14' : 'top-[-120px]'}`}>

...
const Blogs = () => {
    return (
        <div className='my-[5vw]'>
            <h1 className='text-[3vw] font-bold text-indigo-900'>Blog <span className='text-orange-600'>Articles</span></h1>
            <div className='md:flex md:justify-around'>
                <div className="flex justify-center my-[5vw]">
                    <div className="rounded-lg shadow-lg bg-indigo-50 max-w-sm p-5 h-[450px] w-[350px] hover:bg-orange-50 mx-2">
